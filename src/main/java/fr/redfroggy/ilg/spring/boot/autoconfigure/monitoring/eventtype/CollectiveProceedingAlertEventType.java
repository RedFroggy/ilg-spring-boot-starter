...
public class CollectiveProceedingAlertEventType extends AlertEventType {

    public CollectiveProceedingAlertEventType(Alert alert, EventDetailProjection eventDetail) {
